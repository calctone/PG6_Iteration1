...
- (void)viewDidLoad {
    ...
    go = [[NSBundle mainBundle] pathForResource:@"traffic-sign-go" ofType:@"bmp"];
    doNotEnter = [[NSBundle mainBundle] pathForResource:@"traffic-sign-do-not-enter" ofType:@"bmp"];
    ...
    [signs addObject:go];
    [signs addObject:doNotEnter];
    [signs addObject:turnLeft];
    [signs addObject:turnRight];
    [signs addObject:slowDown];
